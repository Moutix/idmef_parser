...
class HTMLGenerator
  ...
  def render_footer
    return render FOOTER, {classes: @generator.classes, location: LOCATION}
  end

  def render_head idmef_class
    return render HEAD, {title: TITLE, classes: @generator.classes, idmef_class: idmef_class, location: LOCATION}
  end

  def render_body idmef_class
    return render BODY, {idmef_class: @generator.classes[idmef_class], classes: @generator.classes, location: LOCATION}
  end
